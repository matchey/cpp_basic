//マリカのポイントから賭けのプラスマイナスを表示するプログラム
#include<iostream>
#include<string>
#include<cstdlib>
#include<map>
...
{
	int last_score = points;
	cout<<"Type "<<name<<"'s score (total): ";
	while(1){
		...
		if(!(points<0||points>500)){
			...
			cout<<"score must be in 0~500"<<endl;
			cout<<"Type score(0~500):";
			points=0;
		}
	}
	return points - last_score;
}/*}}}*/
